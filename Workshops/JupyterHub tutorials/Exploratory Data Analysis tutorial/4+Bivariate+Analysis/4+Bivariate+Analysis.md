...
There is no relationship between SalePrice and LotArea (LotSize), since the correlation coefficient is close to 0. There are by the way several outliers obersvable in the plot above.
