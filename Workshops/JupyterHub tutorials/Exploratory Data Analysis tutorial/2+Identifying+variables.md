...
```python
KitchenQualDict = {'Po':0, 'Fa':1, 'TA':2, 'Gd':3, 'Ex':4}
df['KitchenQualN'] = df.KitchenQual.map(KitchenQualDict)
df[['KitchenQual','KitchenQualN']]
```
...
| KitchenQual | Quality of the kitchen | text | Categorical | 0 | Fa, TA, Gd, Ex (Fair, Typical/Average, Good, Excellent) | Gd |
...
```
    ...
    KitchenQualN     1460 non-null int64
    2FlrSF           1460 non-null int64
    dtypes: float64(3), int64(38), object(43)
